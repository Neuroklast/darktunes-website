...
| 3 | DAL/API `organization_id` batches | Stronger — CMS + **Sales Statements** (statements, workspaces, presets, period summaries, bronze import batches) + File Explorer/upload/EPK + storage stats + feedback |
