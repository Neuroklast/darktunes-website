...
| 3 | DAL/API `organization_id` batches | Stronger — **site_settings** + settlement periods + message templates + Sales Statements + CMS catalog + File Explorer/EPK + storage + feedback |
