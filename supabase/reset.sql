...
-- ---------------------------------------------------------------------------
-- organization_id on core CMS tables (Phase 1 tenant isolation)
-- ---------------------------------------------------------------------------
ALTER TABLE public.artists ADD COLUMN IF NOT EXISTS organization_id UUID NOT NULL
  DEFAULT '00000000-0000-0000-0000-000000000000' REFERENCES public.organizations (id);
ALTER TABLE public.releases ADD COLUMN IF NOT EXISTS organization_id UUID NOT NULL
  DEFAULT '00000000-0000-0000-0000-000000000000' REFERENCES public.organizations (id);
ALTER TABLE public.news_posts ADD COLUMN IF NOT EXISTS organization_id UUID NOT NULL
  DEFAULT '00000000-0000-0000-0000-000000000000' REFERENCES public.organizations (id);
ALTER TABLE public.videos ADD COLUMN IF NOT EXISTS organization_id UUID NOT NULL
  DEFAULT '00000000-0000-0000-0000-000000000000' REFERENCES public.organizations (id);
ALTER TABLE public.concerts ADD COLUMN IF NOT EXISTS organization_id UUID NOT NULL
  DEFAULT '00000000-0000-0000-0000-000000000000' REFERENCES public.organizations (id);
ALTER TABLE public.release_submissions ADD COLUMN IF NOT EXISTS organization_id UUID NOT NULL
  DEFAULT '00000000-0000-0000-0000-000000000000' REFERENCES public.organizations (id);
...
-- RLS: SaaS tables (admin + org member read where applicable)
...
-- Demo tenant for multi-org RLS / SaaS testing
INSERT INTO public.organizations (id, name, slug, status) VALUES
